...
// Avatar circular + botón de archivo oculto disparado por un botón real,
// en vez del <input type="file"> nativo (que no se puede estilar bien).
    ...
    <div>
      ...
      <div className="flex items-center gap-4">
        {imageUrl ? (
          ...
          <div className="w-14 h-14 rounded-full bg-gray-200 flex items-center justify-center text-gray-400 shrink-0">
